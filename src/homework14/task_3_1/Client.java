...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        AbstractAuthentication guestAuthentication = new GuestAuthentication();
        AbstractAuthentication userAuthentication = new UserAuthentication();
        AbstractAuthentication administratorAuthenticationAuthentication = new AdministratorAuthentication();

        guestAuthentication.setNextAuthentication(userAuthentication);
        userAuthentication.setNextAuthentication(administratorAuthenticationAuthentication);

        for (Account user : users) {
            guestAuthentication.authenticate(user, usersAccounts, adminsAccounts);
        }
    }
}
